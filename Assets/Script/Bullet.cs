...
//this class is used to handle the characteristics of the bullet
public class Bullet : MonoBehaviour {
	...
	void Update () {
		//if (moveFlag == false)
			transform.Translate(Vector3.right*0.23f,Space.World);
		//else
	...
	//if the bullet hits different kinds of bubble then collusion handler
